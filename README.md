...
| **💻 Administrador de la Web** | **[Tu Nombre o Alias Aquí]** | Mantiene el código base (HTML, CSS, JavaScript), gestiona los archivos del repositorio, actualiza la lista de juegos en `game-data.js` y asegura el correcto funcionamiento de la interfaz. |
